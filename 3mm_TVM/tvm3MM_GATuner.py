...
if __name__ == '__main__':
    ...
    try:
        ...
        logging.basicConfig(filename=logPath+'GATuner_3MM.log', level=logging.DEBUG,filemode='w', format='%(name)s - %(levelname)s - %(message)s')
        logging.info('GA Tuner 3MM - {}'.format(datetime.now()))
