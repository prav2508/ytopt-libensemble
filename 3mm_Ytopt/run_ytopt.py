...
p0= CSH.OrdinalHyperparameter(name='p0', sequence= [1, 2, 4, 5, 8, 10, 20, 25, 40, 50, 100, 125, 200, 250, 500, 1000],default_value=8)
p1= CSH.OrdinalHyperparameter(name='p1', sequence= [1, 2, 4, 5, 8, 10, 16, 20, 25, 32, 40, 50, 80, 100, 160, 200, 400, 800],default_value=8)
p2= CSH.OrdinalHyperparameter(name='p2', sequence= [1, 2, 3, 4, 5, 6, 8, 10, 12, 15, 16, 20, 24, 25, 30, 40, 48, 50, 60, 75, 80, 100, 120, 150, 200, 240, 300, 400, 600, 1200],default_value=8)
p3= CSH.OrdinalHyperparameter(name='p3', sequence= [1, 2, 4, 5, 8, 10, 20, 25, 40, 50, 100, 125, 200, 250, 500, 1000],default_value=8)
p4= CSH.OrdinalHyperparameter(name='p4', sequence= [1, 2, 3, 4, 5, 6, 8, 10, 12, 15, 16, 20, 24, 25, 30, 40, 48, 50, 60, 75, 80, 100, 120, 150, 200, 240, 300, 400, 600, 1200],default_value=8)
p5= CSH.OrdinalHyperparameter(name='p5', sequence= [1, 2, 4, 5, 8, 10, 16, 20, 25, 32, 40, 50, 80, 100, 160, 200, 400, 800],default_value=8)
